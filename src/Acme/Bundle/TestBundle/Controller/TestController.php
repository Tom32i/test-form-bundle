...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeTestBundle:Test')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeTestBundle:Test:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeTestBundle:Test')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeTestBundle:Test:edit.html.twig")
     */
